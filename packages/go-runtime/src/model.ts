...
export interface Compiler {
	createEvaluator<O>(signal: AbortSignal, code: string): Promise<Result<Evaluator<O>, string>>;
	createExecutor(signal: AbortSignal, code: string): Promise<Result<Executor, string>>;
}
...
export type GoProgramFactory<R> = (ctx: Context, streams: Streams, code: string) => Promise<R>;
