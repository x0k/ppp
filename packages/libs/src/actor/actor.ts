...
export class Actor<H extends Handlers, E> {
	constructor(
		protected readonly connection: Connection<IncomingMessage<H>, OutgoingMessage<H, E>>,
	...
	private async handleEvent<K extends keyof H>(event: EventMessage<K, Parameters<H[K]>[0]>) {
		try {
