...
jvm.registerNatives({
	Probe: {
		'getStringArg()Ljava/lang/String;': function (thread: JVMThread) {
			return util.initString(thread.getBsCl(), 'FRIDAY');
		},
		'saveNumber(I)V': function (thread: JVMThread, arg0: number) {
			console.log('Number: ', arg0);
		},
		'saveString(Ljava/lang/String;)V': function (thread: JVMThread, arg0: string) {
			console.log('String: ', arg0.toString());
		},
		'saveArray([I)V': function (thread: JVMThread, arg0: number[]) {
			console.log('Array: ', arg0);
		},
		'saveEnum(LDayOfWeek;)V': function (thread: JVMThread, arg0: object) {
