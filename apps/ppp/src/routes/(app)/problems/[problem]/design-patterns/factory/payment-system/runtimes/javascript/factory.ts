...
import Worker from '#lib/runtime/js/test-worker.ts?worker';
...
import type { JsTestWorkerConfig } from '#lib/runtime/js/test-worker.ts';
...
export const factory: TestCompilerFactory<RemoteCompilerFactoryOptions, Input, Output> =
	makeRemoteTestCompilerFactory(Worker, async (_, { jsTestCompilerFactory }: JsTestWorkerConfig) =>
